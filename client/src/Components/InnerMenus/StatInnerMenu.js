...
const StatInnerMenu = withRouter(
  ({ location: { pathname }, dailyTotalTimes, dailyLapses }) => {
    return (
      <>
        <ul>
        ...
        <Route
          path="/stat/daily"
          component={dailyLapses.length === 0 ? Empty : StatDaily}
        />
        <Route
          path="/stat/weeky"
          component={dailyTotalTimes.length === 0 ? Empty : StatWeekly}
        />
        <Route
          path="/stat/monthly"
          component={dailyTotalTimes.length === 0 ? Empty : StatMonthly}
        />
      </>
    );
  }
