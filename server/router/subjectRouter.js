...
import { recordActive, addSubject, delSubject, editSubject, getSubject } from '../controller/subjectController';
...
subjectRouter.post(routes.editSubject, findUser, findSubejct, checkSubjectTitle, editSubject);
